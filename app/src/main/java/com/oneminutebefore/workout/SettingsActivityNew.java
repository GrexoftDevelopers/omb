...
public class SettingsActivityNew extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                || WorkoutsPreferenceFragment.class.getName().equals(fragmentName)
                || FitnessLevelPreferenceFragment.class.getName().equals(fragmentName);
    }
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class WorkoutsPreferenceFragment extends PreferenceFragment {
        @Override
...
//                String userLevel = sharedPreferences.getString(Keys.getUserLevelKey(getActivity()),getString(R.string.default_fitness));
                for (Map.Entry entry : workouts.entrySet()) {
                    ...
                    if (true) { //workoutExercise.getCategory().getId().equals(userLevel) || userLevel.equals("All star")) {
...
//            bindPreferenceSummaryToValue(findPreference("example_list"));
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class FitnessLevelPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pre_fitness_level);
            setHasOptionsMenu(true);
